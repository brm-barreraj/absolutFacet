<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-10-28 22:24:47
...
<div class=" columnWidth" id="cartContent">
    ...
    <p class="name">Botella de Absolut</p>
    
    <div class="cantidad">
      <input type="text" maxlength="2" placeholder="0" class="form-control">
      <div class="controls">
        <button type="button" href="#" class="controls-add">+</button>
        <button type="button" href="#" class="controls-remove">-</button>
      </div>
    </div>
    ...
    <div class="alignCenter cartModule">
      ...
      <p class="price">$99.999</p>
      <p class="name">2 botellas + kit Facet (gorra y maleta)</p>
   ...
   <div class="alignCenter cartModule">
    ...
    <p class="price">$99.999</p>
    <p class="name">3 botellas + kit fiesta (mentas, maletas, camiseta)</p>
    ...
    <a href="checkout" class="btn_pay" id="PAYbtn">Pagar</a>
</div>
