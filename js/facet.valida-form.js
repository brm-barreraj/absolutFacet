jQuery(document).ready(function($) {
	...
	jQuery("#facturacion").validate({
	    ...
	    rules: {
	           ...
	           tel:       {required: true,maxlength: 13, minlength: 7},
	    ...
	    messages: {
	      ...
	      cel:      {required: "Ingresa tu n&uacute;mero de celular", maxlength:"N&uacute;mero no v&aacute;lido", minlength:"N&uacute;mero no v&aacute;lido"},
	      tel:      {required: "Ingresa tu n&uacute;mero de tel&eacute;fono", maxlength:"N&uacute;mero no v&aacute;lido", minlength:"N&uacute;mero no v&aacute;lido"},
